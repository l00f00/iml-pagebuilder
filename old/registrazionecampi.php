<?php
add_filter( 'rwmb_meta_boxes', 'iml_prefix_function' );

function iml_prefix_function( $meta_boxes ) {
    $prefix = '';
...
<?php
add_action( 'init', 'iml_prefix_register_post_type' );
function iml_prefix_register_post_type() {
	$labels = [
